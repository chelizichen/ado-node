...
declare const ref: {
     ...
     */
    def: <T extends string | Function>(key: T, value: any, target?: Object, propertyKey?: string) => void;
    /**
     ...
     */
    get: <T_1 extends string | Function>(key: T_1, target?: Object, propertyKey?: string) => any;
};
export { ref };
