...
declare function defineAdoNodeConfig(config: AdoNodeConfig): AdoNodeConfig;
declare class Connection {
    static connectionPool: mysql.Pool;
    static readConfig(): Promise<void>;
    static createConnection(configInfo: any): Promise<void>;
    static getConnection(): Promise<mysql.PoolConnection>;
}
declare function getConnection(): mysql.Pool;
declare function gerRedis(): Promise<import("@redis/client").RedisClientType<{
    graph: {
