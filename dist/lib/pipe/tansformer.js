        ...
        if (!options || options.exclude) {
            if (classInst instanceof Array) {
                let plain = classInst.map((inst) => {
                    const filt = ioc_1.ref.get(orm_1.ENTITY_CONSTANT.AutoCreate, inst.constructor.prototype);
                ...
                const filt = ioc_1.ref.get(orm_1.ENTITY_CONSTANT.AutoCreate, classInst.constructor.prototype);
