...
let App917Controller = class App917Controller extends ado_node_1.HandleController {
    App917Service;
    async a1() {
...
__decorate([
    (0, ado_node_1.Inject)(App917_service_1.App917Service)
...
__decorate([
    (0, ado_node_1.Get)("/b1"),
    (0, ado_node_1.Pipe)([App917_pipe_1.useIdPipe, App917_pipe_1.userNamePipe])
], App917Controller.prototype, "b1", null);
__decorate([
    (0, ado_node_1.Get)("/c1"),
    (0, ado_node_1.Pipe)(App917_pipe_1.useIdPipe)
], App917Controller.prototype, "c1", null);
App917Controller = __decorate([
    (0, ado_node_1.Controller)("/app917")
], App917Controller);
